...
namespace Core.Services.Products
{
    ...
    public class CreateProductService : ICreateProductService
    {
        ...
        public Product Create(Guid id, string name, string sku, string description, decimal? price, int? stock, IEnumerable<string> tags)
        {
            ...
            _updateProductService.Update(product, name, sku, description, price, stock, tags);
